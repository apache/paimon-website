...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.aa3ffacc7ec540c0200b2bcd76d2ccdc916b86067d8de3c9110a84016e7ed4e4.js',function(){input.required=false;search();});}
