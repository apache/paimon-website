...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/1.3/flexsearch.min.js');loadScript('/docs/1.3/en.search-data.min.fd1832900643eadf93145cc2fed5370a3e2bfc6dd9a0103d1ff7c3b9316d4422.js',function(){input.required=false;search();});}
