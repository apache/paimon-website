...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/1.3/flexsearch.min.js');loadScript('/docs/1.3/en.search-data.min.5707390326b9f22bff631f15202ad3960b068b25d47a8b13538db4f64c3a16c9.js',function(){input.required=false;search();});}
