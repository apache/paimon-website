...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/1.3/flexsearch.min.js');loadScript('/docs/1.3/en.search-data.min.cccfda68cce69587c3039fd886f9eb619d0c89775a6462a56a509ba84298e479.js',function(){input.required=false;search();});}
