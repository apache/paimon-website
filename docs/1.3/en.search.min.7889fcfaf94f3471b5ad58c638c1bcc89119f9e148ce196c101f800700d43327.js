...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.e561fed1fa331477be17995bd88d1618f10038315907134a4580c9547d7f0f2c.js',function(){input.required=false;search();});}
