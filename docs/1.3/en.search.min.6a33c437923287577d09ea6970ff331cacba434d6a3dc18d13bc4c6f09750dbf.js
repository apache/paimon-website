...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.43bc9d82e94ac76acd74a36338954cdbe506047d5a288933f762aca384effd05.js',function(){input.required=false;search();});}
