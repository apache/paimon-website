...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/1.4/flexsearch.min.js');loadScript('/docs/1.4/en.search-data.min.74510faeb85d1dd73375476212ece8ee646d5a69a11fac617ba57aa994347f75.js',function(){input.required=false;search();});}
