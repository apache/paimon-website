...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/0.6/flexsearch.min.js');loadScript('/docs/0.6/en.search-data.min.b5f0afaab227a1fab13fbdc4ecef3c190e8945e982766ff28b6bab6da88dc2ed.js',function(){input.required=false;search();});}
