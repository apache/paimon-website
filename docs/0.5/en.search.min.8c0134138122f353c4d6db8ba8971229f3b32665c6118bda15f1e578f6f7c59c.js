...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.b06cfe93a264daf406c1b32a22e0495e19877aabe4120999748decae93c8c691.js',function(){input.required=false;search();});}
