...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/0.5/flexsearch.min.js');loadScript('/docs/0.5/en.search-data.min.93d1e11927e872f36ede53bd3d35fcedc4ddb7d29c0005b6b926c2068c7bd7b0.js',function(){input.required=false;search();});}
