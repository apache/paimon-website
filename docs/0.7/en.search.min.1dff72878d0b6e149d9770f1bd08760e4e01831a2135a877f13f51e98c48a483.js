...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/0.7/flexsearch.min.js');loadScript('/docs/0.7/en.search-data.min.15e6d59bc5aedfa2e250e91305b9cee02be93f35ae5b83e00a7ed22a329e5e1b.js',function(){input.required=false;search();});}
