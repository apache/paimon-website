...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.f2fd83cee9c9dfab4ce21ac38a273436bd2c10f3cb6af7385354aab2ec39529a.js',function(){input.required=false;search();});}
