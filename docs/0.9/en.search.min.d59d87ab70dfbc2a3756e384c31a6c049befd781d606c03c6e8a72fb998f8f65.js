...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/0.9/flexsearch.min.js');loadScript('/docs/0.9/en.search-data.min.f1fe55f1390ce7a14701d9dd0410ff183ec9784e283872efc8096dec8df30908.js',function(){input.required=false;search();});}
