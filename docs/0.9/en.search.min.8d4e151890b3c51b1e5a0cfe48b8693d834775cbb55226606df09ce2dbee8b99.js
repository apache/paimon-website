...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.fe3834e37759def301212c2da6b66c2587afac44100cb48b1c4f391733102a57.js',function(){input.required=false;search();});}
