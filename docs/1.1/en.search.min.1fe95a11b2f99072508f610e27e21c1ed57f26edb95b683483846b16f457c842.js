...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/1.1/flexsearch.min.js');loadScript('/docs/1.1/en.search-data.min.de3533ff019b148ee4a5fca32d753ddac6c0069b218a309474e8bc1b2f559d1f.js',function(){input.required=false;search();});}
