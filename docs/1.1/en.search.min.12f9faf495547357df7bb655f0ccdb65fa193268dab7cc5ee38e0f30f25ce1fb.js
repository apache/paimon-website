...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/1.1/flexsearch.min.js');loadScript('/docs/1.1/en.search-data.min.941a6ccd540336109e6eb37df7fc23931f5a4610f0ec83f19fa92d341db6318a.js',function(){input.required=false;search();});}
