...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.96c35fea47c8922990d7b6bdb965d41d5ae413758a7c2f18eb9ec6f2242a2d61.js',function(){input.required=false;search();});}
