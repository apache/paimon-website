...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/0.8/flexsearch.min.js');loadScript('/docs/0.8/en.search-data.min.206200ba44d79af36cc05f122aa09afb71901f06ee465bd8ef41ede6b49d3f70.js',function(){input.required=false;search();});}
