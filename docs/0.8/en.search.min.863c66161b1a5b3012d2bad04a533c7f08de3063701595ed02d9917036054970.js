...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/0.8/flexsearch.min.js');loadScript('/docs/0.8/en.search-data.min.d700068c3af26bf7bd336ca3cc5c09f53bb3e19a9a466634fdb4d5b89ed3f174.js',function(){input.required=false;search();});}
