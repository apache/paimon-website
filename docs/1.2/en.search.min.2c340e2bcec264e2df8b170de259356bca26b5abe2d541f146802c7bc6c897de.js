...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/1.2/flexsearch.min.js');loadScript('/docs/1.2/en.search-data.min.333ee5c7c475e52ac2a88e40ffb94867ccc0ab9f92f9e8b57f94903f32d63eb6.js',function(){input.required=false;search();});}
