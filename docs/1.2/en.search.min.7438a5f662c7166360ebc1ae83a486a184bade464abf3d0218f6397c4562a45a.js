...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/1.2/flexsearch.min.js');loadScript('/docs/1.2/en.search-data.min.ae83412e65183dcff7fb066e5af470b8698322de6dd0e0487010fbb5a64fa268.js',function(){input.required=false;search();});}
