...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.433842efe7baf50d5ab54d20e7ec1e56cc3451d49668c8a589dede97181ca000.js',function(){input.required=false;search();});}
