...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.31a05af7e811564178e7457c142f9d2c9c9205adee08fd5820ab07c694ff09f2.js',function(){input.required=false;search();});}
