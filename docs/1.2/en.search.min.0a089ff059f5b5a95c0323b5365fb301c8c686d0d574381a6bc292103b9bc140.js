...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.2b480d89e14ba8cd86edcd1a655bd4034b45cecedb12741d99f9eb3c13f5e54a.js',function(){input.required=false;search();});}
