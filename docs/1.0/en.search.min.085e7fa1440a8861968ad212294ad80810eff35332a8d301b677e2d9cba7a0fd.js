...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/1.0/flexsearch.min.js');loadScript('/docs/1.0/en.search-data.min.d35b1cadf109a9e00849cfe5333a134a469232fe3299790be9c5fe3a72629eb2.js',function(){input.required=false;search();});}
