...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/1.0/flexsearch.min.js');loadScript('/docs/1.0/en.search-data.min.6897447b48587eae890d20f404d73ea816796936893e9be8fc6c8c6e72c8c274.js',function(){input.required=false;search();});}
