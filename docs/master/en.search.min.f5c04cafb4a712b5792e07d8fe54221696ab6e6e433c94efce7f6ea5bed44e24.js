...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.5b740615a7e00ee46badcd12c120b07aae5034c66de78bcd5035927a2845be5c.js',function(){input.required=false;search();});}
