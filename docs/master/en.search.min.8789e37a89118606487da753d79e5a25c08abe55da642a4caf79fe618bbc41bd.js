...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.4bfe5a4ed346b7ef2b7694178941ccc2f70d4fe4ec42efce6406792b031f6761.js',function(){input.required=false;search();});}
