...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.a7b7b378b348d053ae79c001c09dc969b7cfe44bf1e89adef6dc69f9b760b8db.js',function(){input.required=false;search();});}
