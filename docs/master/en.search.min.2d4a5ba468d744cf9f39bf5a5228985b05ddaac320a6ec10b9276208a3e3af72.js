...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.9e7785f134ce5426a66f2631a666bbdbf0d0d2f1dfd69034cc67809061f2512f.js',function(){input.required=false;search();});}
