...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.ca982d6f100cd11c1b153d4c6128328317712a4b41d4b3a5e03806e151c9db34.js',function(){input.required=false;search();});}
