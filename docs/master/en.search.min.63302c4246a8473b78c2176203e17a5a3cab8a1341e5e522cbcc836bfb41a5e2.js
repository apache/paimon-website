...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.030b95fbdfe23fa754fdb2a43ad661a9da92066bdd80f3edfaaea4a57acd5996.js',function(){input.required=false;search();});}
