...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.c5ce4cf9b3cf990a1f67709d4b56ea8ce57d4d7d0dfb3ec733a5c58b206ff449.js',function(){input.required=false;search();});}
