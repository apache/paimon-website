...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.96d5cc4555f6302d150cb275cd29d0a0a5d2c2bc93be5e91b4dd5220e0ec33ce.js',function(){input.required=false;search();});}
